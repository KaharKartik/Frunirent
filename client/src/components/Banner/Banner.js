...
const Banner = () => {
  ...
  const slides = [
    {
      imgSrc: bannerImgOne,
      text: "Enhance Your Living Experience",
      Subtext:
    ...
    {
      imgSrc: bannerImgTwo,
      text: "Quality Living Assets",
      Subtext:
        "Discover our wide range of Luxurious Products and consumables designed for better live experience",
      buttonLink: "/shop",
      buttonText: "About-us",
    },
    {
